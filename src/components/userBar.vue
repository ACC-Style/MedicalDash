	...
	<section id="userbar" class="m-x_n4 m-t_n4 p_4 p-t_3 p-b_1 m-b_4 bg_primary-n2 grid-x font_n1">
		<div class="grid-x flex-child-auto c_white-4">
			...
			<router-link to="profile" tag="div" class="cell auto text-center">
				<span class>
					<i class="fas fa-user font-golden_1 c_white-6"></i> lvl:32
				</span>
			</router-link>
			<router-link to="inapppurchase" tag="div" class="cell shrink self-end">
				<i class="far fa-gem font-golden_1 c_white-6"></i>
				<i class="fas fa-times p-y_3 p-x_2 font-golden_0"></i>
				<span class>105</span>
			</router-link>
		</div>
		<router-link to="profile" class="d_block c_white-4" style="width:100%">
			<div class="grid-x">
				<div class="small-12 cell">
					...
					<p class="font_n3 c_primary-4 m-b_2">100,254 xp to next level</p>
				</div>
			</div>
		</router-link>
	</section>
